...
* **Limitaciones para las medidas:** las funciones y expresiones de DAX que se pueden usar en las medidas están restringidas. Nuevamente, la función de autocompletar restringirá las funciones que aparecen y se producirá un error si se usa una función o una expresión no válida. El motivo es garantizar que las medidas están restringidas a medidas simples con pocas probabilidades de generar problemas de rendimiento.
