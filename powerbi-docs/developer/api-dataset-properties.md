...
crossFilteringBehavior     | Cadena        |    La dirección de filtro de la relación: OneDirection (valor predeterminado), BothDirections, Automatic       | False        | False        
