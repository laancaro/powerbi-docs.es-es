...
* Con el [portal de administración de Power BI](../service-admin-portal.md#power-bi-embedded-settings).
...
## <a name="embedding-setup-tool-for-embedding"></a>Herramienta de configuración de inserción para insertar
