...
PowerBI.com es una solución de software como servicio (SaaS) empresarial que incluye numerosas funcionalidades, como colaboración social, suscripción a correo electrónico y otras características. PowerBI.com ayuda tanto a los ISV como a los desarrolladores a administrar el contenido de su solución de análisis insertado contenido y la configuración del nivel de los inquilinos.

Power BI Embedded es un conjunto de API de plataforma como servicio (PaaS) que los desarrolladores pueden usar para crear una solución de análisis insertado.
...
| Inserción de artefactos desde un área de trabajo de la aplicación de Power BI | Sí | Sí | Sí |
...
Para [promover la solución a producción](embed-sample-for-customers.md#move-to-production), es necesario asignar el contenido de Power BI (el área de trabajo de la aplicación) que la aplicación usa a una capacidad de Power BI Embedded (SKU A).
...
Suele haber confusión a la hora de usar RLS frente a los filtros de JavaScript, ya que un método trata sobre cómo controlar lo que puede ver un usuario específico y el otro va sobre la optimización de la vista del usuario.
