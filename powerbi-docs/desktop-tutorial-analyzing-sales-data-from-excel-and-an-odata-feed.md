...
Power BI Desktop permite interactuar con objetos visuales que se filtran y resaltan entre sí para descubrir las tendencias futuras. Para obtener más información, consulte [Filtros y resaltado en informes de Power BI](power-bi-reports-filters-and-highlighting.md).
...
* [Vea vídeos de Power BI Desktop](/power-bi/desktop-videos)
