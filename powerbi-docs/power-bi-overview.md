...
description: 'Información general de Power BI y cómo las distintas partes encajan entre sí: Power BI Desktop, servicio Power BI, Power BI Mobile y Report Server.'
author: mihart
manager: kfile
ms.service: powerbi
...
Un flujo de trabajo común en Power BI comienza con la conexión a orígenes de datos y la compilación de un informe en **Power BI Desktop**. Ese informe se publica entonces desde **Desktop** en el **servicio Power BI** y se comparte, para que los usuarios del **servicio** y el **dispositivo móvil** puedan *usarlo* (verlo e interactuar con él). En ocasiones, puede que desee ofrecer a sus compañeros permisos similares a los suyos (permisos de *creador*), a fin de que puedan usar el **servicio** para editar informes, crear paneles y compartir su trabajo.
...
[Inicio de sesión y conexión a un servicio](/power-bi/service-tutorial-connect-to-github.md)
