...
Este tutorial usa el servicio Power BI y el paquete de contenido Ejemplo de recursos humanos. Debido a que las experiencias del informe son tan similares, también puede seguir utilizando Power BI Desktop y el archivo .pbix de ejemplo. 
