...
* La respuesta detallada a esta pregunta está disponible en el vínculo siguiente: [Puertos de puerta de enlace](/data-integration/gateway/service-gateway-communication#ports)
