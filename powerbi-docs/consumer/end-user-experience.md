...
1. Abra app.powerbi.com y seleccione el vínculo de **Ejemplos**. 
    ...
    ![Abrir el servicio Power BI por primera vez](./media/end-user-experience/power-bi-new-user.png)
...
![Pestaña Paneles abierta](./media/end-user-experience/power-bi-open-dashboard.png)
...
1. Con el panel abierto, seleccione **Favorito** en la esquina superior derecha.
   ...
   ![Adición de favorito](./media/end-user-experience/powerbi-dashboard-favorite.png)
...
4. Seleccione el nombre del informe para abrirlo en el editor de informes.
    ...
    ![Abrir informe](./media/end-user-experience/power-bi-report-open.png)
