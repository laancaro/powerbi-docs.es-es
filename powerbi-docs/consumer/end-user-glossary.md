...
**data model, Excel Data Model (modelo de datos, modelo de datos de Excel)**
...
**drill up, drill down, drillthrough (rastrear agrupando datos, explorar en profundidad, obtener detalles)**
...
**focus mode (modo de enfoque)** [servicio Power BI]

**Free account (cuenta gratuita)** Vea “Cuenta” en esta recopilación de términos.

**full screen, full-screen mode (pantalla completa, modo de pantalla completa0** [Servicio Power BI]
...
**left navigation (left nav) (panel de navegación izquierdo (nav. izq.))** Controles situados en el borde izquierdo del servicio Power BI.
...
**navigation pane (panel de navegación)** Vea **Panel de navegación izquierdo**.
...
**page (página)** Los informes tienen una o más páginas. Cada pestaña de la parte inferior del lienzo del informe representa una página.
...
**pin, unpin (anclar, desanclar)** Acción de colocar un objeto visual, normalmente de un informe, en un panel.
...
**report server (servidor de informes)** Instancia de un servidor de informes.
...
**service (servicio)** Vea *servicio Power BI*
