...
ms.locfileid: "46565208"
---
# <a name="take-a-tour-of-the-report-filters-pane"></a>Ver el panel Filtros del informe
En este artículo se analiza en profundidad el panel Filtros del informe. Verá el panel en la [vista de edición y la vista de lectura del servicio Power BI](end-user-reading-view.md) y en la [vista de informe de Power BI Desktop](../desktop-report-view.md).
...
## <a name="clear-a-filter"></a>Borrado de un filtro
 Tanto en el modo de filtrado básico como en el avanzado, seleccione el icono de borrador ![](media/end-user-report-filter/pbi_erasericon.jpg) para borrar el filtro. 
...
[Interacción con filtros y resaltado en la Vista de lectura del informe](end-user-reading-view.md)  
[Creación de filtros en la Vista de edición de los informes](../power-bi-report-add-filter.md)  
[Cambiar el filtro cruzado y el resaltado cruzado entre los objetos visuales de los informes](end-user-interactions.md)
