...
description: Documentación para mostrar un icono panel, un icono de panel, un informe o una visualización de informe de Power BI en el modo de enfoque o en el modo de pantalla completa
author: mihart
manager: kvivek
ms.reviewer: ''
ms.custom: seodec18
...
![Panel en modo de pantalla completa antes y después](media/end-user-focus/power-bi-full-screen-comparison.png)
...
![Panel en modo de pantalla completa antes y después](media/end-user-focus/power-bi-focus-compare.png)
...
Menú de paneles    
![Menú de paneles](media/end-user-focus/power-bi-full-screen-menu-dashboard.png)    

Menú de páginas de informes    
![Menú de informes](media/end-user-focus/power-bi-report-menu.png)    
  ...
  * ![Icono Ajustar a la pantalla](media/end-user-focus/power-bi-fit-to-width.png)    
...
### <a name="focus-mode-in-dashboards"></a>Modo de enfoque en paneles
...
2. Mantenga el puntero sobre un icono de panel o una visualización de informe, seleccione el botón de puntos suspensivos (...) y elija **Abrir en modo de enfoque**.
    ...
    ![menú de puntos suspensivos del icono](media/end-user-focus/power-bi-dashboard-focus-mode.png).
...
2. Mantenga el ratón sobre el gráfico de área de la esquina inferior izquierda y seleccione el icono de **modo de enfoque** ![icono de modo de enfoque](media/end-user-focus/pbi_popout.jpg).  
