---
title: Suscripción a informes y paneles para consumidores de Power BI
description: Aprenda a suscribirse a una instantánea de un informe y panel de Power BI.
author: mihart
manager: kvivek
ms.reviewer: ''
featuredvideoid: ''
