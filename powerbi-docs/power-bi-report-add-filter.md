...
Puede agregar un filtro a un objeto visual específico de dos maneras diferentes (es decir, un "filtro de objeto visual"). 
...
1. Abra un [informe en la vista de edición](service-the-report-editor-take-a-tour.md).
