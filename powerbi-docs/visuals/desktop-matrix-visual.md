...
Puede crear objetos visuales de matriz en **Power BI Desktop** y en elementos cruzados e informes del **servicio Power BI** dentro de la matriz con otros objetos visuales en esa página de informe. Por ejemplo, puede seleccionar filas, columnas y e incluso celdas individuales y realizar un resaltado cruzado. Además, las celdas individuales y las selecciones de celdas múltiples pueden copiarse y pegarse en otras aplicaciones. 
...
Cuando se selecciona **Explorar en profundidad**, aparece el siguiente nivel de la jerarquía de la columna para *Región > Este* que, en este caso, es *Recuento de oportunidades*. La otra región se muestra, pero está atenuada.
...
El objeto visual **Matriz** aplica sangría automáticamente a las subcategorías de una jerarquía debajo de cada elemento primario, que se denomina **Diseño escalonado**.
...
Si desactiva **Diseño escalonado**, Power BI muestra subcategorías en otra columna en lugar de con una sangría debajo de la categoría primaria.
...
Con el objeto visual Matriz, puede aplicar **formato condicional** (colores, sombreado y barras de datos) al fondo de las celdas de la matriz y también al texto y a los valores propiamente dichos.
