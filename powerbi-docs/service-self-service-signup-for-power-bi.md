...
description: Aprenda a registrarse en Power BI y empiece a usarlo para sus necesidades de análisis y visualización de datos.
author: mgblythe
ms.reviewer: ''
ms.service: powerbi
...
## <a name="sign-up-for-a-power-bi-account"></a>Registrarse para obtener una cuenta de Power BI
