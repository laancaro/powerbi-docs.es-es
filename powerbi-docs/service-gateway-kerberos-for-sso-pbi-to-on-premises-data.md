...
Se admiten actualmente los siguiente orígenes de datos basados en la [delegación restringida de Kerberos](https://technet.microsoft.com/library/jj553400.aspx):
